...
public class Deck {
    ...
    //metodo que compra cartas de acordo com a quantidade informada
    public Carta[] comprarCartas(int n) throws IllegalArgumentException {

        if(estaVazio()){
            throw new IllegalArgumentException("Nao foi possivel comprar cartas porque nao ha cartas no deck");
        }
